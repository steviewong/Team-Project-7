...
import flask
import numpy
from flask import Flask, Response, request, render_template, redirect, url_for, sessions
...
@app.route('/')
def helloworld():
    #email = dict(sessions).get('email', None)
...
google = oauth.register(
    name = "google",
    client_id = '495171283112-rogk904dltlqpics697smn1ca8acmsc0.apps.googleusercontent.com',
    client_secret = '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',
...
def authorize():
    ...
    sessions['email'] = user_info['email']
    return redirect('/')
